<template>
    <div class="container">
        ...
        <div class="wrapper">
            ...
            <div class="wrap">
                ...
                <div class="topData">
                    ...
                    <div class="rData clearfix">
                        <dl class="elem">
                            <dt class="dt"> <p class="number1" :class="market24[3] > 0 ? 'green': 'red'" style="font-size: 20px;    font-family: Helvetica;">{{math_make(newDeal,'p')}}</p></dt>
                            <dd class="dd" style="padding-top: 4px">
                                <p class="number2 gray" style="    font-family: Helvetica;">{{lang == 'en'? (MarketfbMes.usd*newDeal == 0 ? '--': '$'+Number(MarketfbMes.usd*newDeal || 0).toFixed(2)): (MarketfbMes.cny*newDeal == 0 ? '--': '¥'+Number(MarketfbMes.cny*newDeal || 0).toFixed(2))}}</p>
                            </dd>
                        </dl>
                        <dl class="elem">
                            ...
                            <dd class="dd">
                                ...
                                <p  style="font-family: Helvetica;" class="number2 sm" :class="market24[3] > 0 ? 'green': 'red'">{{market24[3] ? Number((market24[3]|| 0)*100).toFixed(2)+'%' :'--' }}</p>
                            </dd>
                        </dl>
                        <dl class="elem">
                            <dt class="dt">{{ $t("24h-high") }}</dt>
                            <dd class="dd">
                                <p class="number1" style="font-family: Helvetica;">{{market24[0] || '--'}}</p>
                            </dd>
                        </dl>
                        <dl class="elem">
                            <dt class="dt">{{ $t("24h-low") }}</dt>
                            <dd class="dd">
                                <p class="number1" style="font-family: Helvetica;">{{market24[1] || '--'}}</p>
                            </dd>
                        </dl>
                        <dl class="elem">
                            <dt class="dt">{{ $t("24h-volume") }}</dt>
                            <dd class="dd">
                                <p class="number1" style="font-family: Helvetica;">{{market24[2] || '--'}} <b class="b">{{marketA[0]}}</b></p>
                            </dd>
                        </dl>
                    </div>
                </div>
                ...
                <div class="wrap">
                    ...
                    <div class="clearfix">
                        <div  class="leftCon rightCon">
                            ...
                            <marketList routerName="market" :marketN="marketA[0]"></marketList>
                                ...
                                <div class="dealList ">
                                    <ul class="detail ">
                                        <li v-for="(item) in dealData" >
                                            <p  style="font-family: Helvetica;" :class="(item[3] == '2'? 'red':'green')" >{{math_make(item[0],'p')}}</p>
                                            <p class="r" style="font-family: Helvetica;">{{ math_make(item[1],'n')}}</p>
                                            <p class=" " style="font-family: Helvetica;">{{dataUp(item[2])}}</p>
                            ...
                            <div class="chartsWrap mb">
                                ...
                                <div class="chartDom">
                                    <div class="chartInside">
                                        ...
                                        <chart :marketA="marketA" :lang="lang"   > </chart>
                                        <!--<div id="kline_m"></div>-->
                                        ...
                                        <ul class="">
                                            ...
                                            <li class="">
                                                <div class="content clearfix">
                                                    <div class="top">
                                                        <h3>
                                                            <span :class="hasTabPrice =='1' ? 'cur': ''" @click="tabPrice(1)">{{ $t("limitorder") }}</span>
                                                            <span @click="tabPrice(2)" :class="hasTabPrice =='2' ? 'cur': ''">{{ $t("Market") }}</span>
                                                        </h3>
                                                            ...
                                                            <div class="content clearfix">
                                                                <div  class="left fl">
                                                                    ...
                                                                    <dl class="elem clearfix">
                                                                        ...
                                                                        <dd class="dd hasArrow">
                                                                            <input type="text" @focus="handleinput()" v-on:blur="yourmethod" class="price"  v-model="priceVue_b"  @input="price($event,'b')">
                                                                            ...
                                                                            <!--</div>-->
                                                                            <!-- 提示浮层 start -->
                                                                            <div v-show="hidden" class="dataTip">
                                                                    ...
                                                                    <dl class="elem  clearfix">
                                                                        ...
                                                                        <dd class="dd">
                                                                            <input type="text"  v-model="amountVue_b" @input="Amount($event,'b')" @focus="priceTitfn()" @blur="buyPop = false">
                                                                    ...
                                                                    <dl class="elem  clearfix">
                                                                        ...
                                                                        <dd class="dd">
                                                                            <input type="text" v-model="total_b" @input="Tota($event,'b')">

                                                                            <b class="keyword">{{marketA[0]}}</b>
                                                                        </dd>
                                                                    </dl>
                                                                    <p v-show="ispublicTit_6" style=" position: absolute;" class="red f12">{{$t("Please enter price or amount")}}</p>
                                                                    <p v-show="ispublicTit_1" style=" position: absolute;" class="red f12">{{publicTit}}</p>
                                                                    <div class="btnWrap">
                                                                        <a href="javascript:;" style="box-shadow:none" v-if="this.$store.state.isLogin" @click="transaction('1')"  :class="hasDealBbut_b ?'btn_disabled' :''" class="btn buy_btn">{{ $t("buy") }} {{marketA[1]}}</a>
                                                                        <!-- 登录前 按钮状态 start -->
                                                                        <div v-else class="nologo"><a :href="'#/login?market='+marketA[0]+':'+marketA[1]" style="box-shadow:none" class="link">{{ $t("login") }}</a> {{ $t("or") }}  <a :href="'#/register?market='+marketA[0]+':'+marketA[1]" class="link" >{{ $t("create account") }}</a> {{ $t("to trade") }}</div>
                                                                        <!-- 登录前 按钮状态 end -->
                                                                    </div>
                                                                </div>
                                                                <div   class="right  fr">
                                                                    ...
                                                                    <dl class="elem clearfix">
                                                                        ...
                                                                        <dd class="dd hasArrow focus">
                                                                            ...
                                                                            <input  @focus="handleinputtwo()" v-on:blur="yourmethodtwo" type="text" v-model="priceVue_s"  @input="price($event,'s')">
                                                                            <b class="keyword">{{marketA[0]}}</b>
                                                                            <!--<div class="arrow">-->
                                                                            <!--<b class="up"></b>-->
                                                                            <!--<b class="down"></b>-->
                                                                            <!--</div>-->
                                                                            <!-- 提示浮层 start -->
                                                                            <div v-show="hiddentwo" class="dataTip">
                                                                    ...
                                                                    <dl class="elem  clearfix">
                                                                        <dt class="dt">{{ $t("amount") }} :</dt>
                                                                        <dd class="dd">
                                                                            <input type="text" v-model="amountVue_s"  @input="Amount($event,'s')">
                                                                            <b class="keyword">{{marketA[1]}}</b>
                                                                    ...
                                                                    <dl class="elem  clearfix">
                                                                        <dt class="dt">{{ $t("total") }} :</dt>
                                                                        <dd class="dd">
                                                                            <input type="text" v-model="total_s"  @input="Tota($event,'s')">
                                                                            <b class="keyword">{{marketA[0]}}</b>
                                                                        </dd>
                                                                    </dl>
                                                                    <p  v-show="ispublicTit_5"  style="position: absolute;" class="red f12">{{$t("Please enter price or amount")}}</p>
                                                                    <p v-show="ispublicTit_2" style=" position: absolute;" class="red f12">{{publicTit}}</p>
                                                                    <div class="btnWrap">
                                                                        <a href="javascript:;" v-if="this.$store.state.isLogin" style="box-shadow:none" @click="transaction('2')" :class="hasDealBbut_s ?'btn_disabled' :''" class="btn sell_btn">{{$t('sell')}} {{marketA[1]}}</a>
                                                                        <div v-else class="nologo"><a :href="'#/login?market='+marketA[0]+':'+marketA[1]" class="link 11">{{ $t("login") }}</a> {{ $t("or") }} <a :href="'#/register?market='+marketA[0]+':'+marketA[1]" class="link">{{ $t("create account") }}</a> {{ $t("to trade") }}</div>
                                                            ...
                                                            <div class="content clearfix">
                                                                <div  class="left fl">
                                                                    ...
                                                                    <dl class="elem clearfix">
                                                                        <dt class="dt">{{ $t("price") }} :</dt>
                                                                        <dd class="dd hasArrow">
                                                                            <el-input :placeholder="$t('The best market price_buy')"  :disabled="true"> </el-input>
                                                                    ...
                                                                    <dl class="elem  clearfix">
                                                                        <dt class="dt">{{$t('total')}} :</dt>
                                                                        <dd class="dd">
                                                                            <input type="text"  v-model="totalS_b" @input="Tota($event,'b','mbuy')" @focus="priceTitfn()" @blur="buyPop = false">
                                                                            <b class="keyword">{{marketA[0]}}</b>
                                                                        </dd>
                                                                    </dl>
                                                                    <dl class="elem  clearfix">
                                                                        <dt class="dt"></dt>
                                                                        <dd class="dd list">
                                                                            <a href="javascript:;" @click="positionChange('0.25','1','s')" class="inside">25%</a>
                                                                            <a href="javascript:;" @click="positionChange('0.5','1','s')" class="inside">50%</a>
                                                                            <a href="javascript:;" @click="positionChange('0.75','1','s')" class="inside">75%</a>
                                                                            <a href="javascript:;" @click="positionChange('1','1','s')" class="inside">100%</a>
                                                                        </dd>
                                                                    </dl>
                                                                    <p v-show="ispublicTit_3" style=" position: absolute;" class="red f12">{{$t("Min Limit")}}{{min_limit}}</p>
                                                                    <p v-show="ispublicTit_1" style=" position: absolute;" class="red f12">{{publicTit}}</p>
                                                                    <p v-show="ispublicTit_7" style=" position: absolute;" class="red f12">{{$t("Insufficient available balance")}}</p>
                                                                    <div class="btnWrap">
                                                                        <a href="javascript:;" style="box-shadow:none" v-if="this.$store.state.isLogin" @click="transactionS('1')"  :class="hasDealBbut_b ?'btn_disabled' :''" class="btn buy_btn">{{ $t("buy") }} {{marketA[1]}}</a>
                                                                        <!-- 登录前 按钮状态 start -->
                                                                        <div v-else class="nologo"><a :href="'#/login?market='+marketA[0]+':'+marketA[1]" style="box-shadow:none" class="link">{{ $t("login") }}</a> {{ $t("or") }}  <a :href="'#/register?market='+marketA[0]+':'+marketA[1]" class="link" >{{ $t("create account") }}</a> {{ $t("to trade") }}</div>
                                                                        <!-- 登录前 按钮状态 end -->
                                                                    </div>
                                                                ...
                                                                <div   class="right  fr">
                                                                    ...
                                                                    <dl class="elem clearfix">
                                                                        ...
                                                                        <dd class="dd hasArrow focus">
                                                                            <!--<input type="text" readonly="readonly" value="市价">-->
                                                                            <el-input :placeholder="$t('The best market price')"  :disabled="true"> </el-input>
                                                                            <b class="keyword">{{marketA[0]}}</b>
                                                                        </dd>
                                                                    </dl>
                                                                    <dl class="elem  clearfix">
                                                                        <dt class="dt">{{ $t("amount") }} :</dt>
                                                                        <dd class="dd">
                                                                            <input type="text" v-model="amountVueS_s"  @input="Amount($event,'s','mbuy')">
                                                                            <b class="keyword">{{marketA[1]}}</b>
                                                                        </dd>
                                                                    </dl>
                                                                    <dl class="elem  clearfix">
                                                                        ...
                                                                        <dd class="dd list">
                                                                            <a href="javascript:;" @click="positionChange('0.25','2','s')" class="inside cur">25%</a>
                                                                            <a href="javascript:;" @click="positionChange('0.5','2','s')" class="inside">50%</a>
                                                                            <a href="javascript:;" @click="positionChange('0.75','2','s')" class="inside">75%</a>
                                                                            <a href="javascript:;" @click="positionChange('1','2','s')" class="inside">100%</a>
                                                                        </dd>
                                                                    </dl>
                                                                    <p v-show="ispublicTit_4" style=" position: absolute;" class="red f12">{{$t("Please input sell amount")}} </p>
                                                                    <p v-show="ispublicTit_2" style=" position: absolute;" class="red f12">{{publicTit}}</p>
                                                                    <p v-show="ispublicTit_8" style=" position: absolute;" class="red f12">{{$t("Insufficient available balance")}}</p>
                                                                    <div class="btnWrap">
                                                                        <a href="javascript:;" v-if="this.$store.state.isLogin" style="box-shadow:none" @click="transactionS('2')" :class="hasDealBbut_s ?'btn_disabled' :''" class="btn sell_btn">{{$t('sell')}} {{marketA[1]}}</a>
                                                                        <div v-else class="nologo"><a :href="'#/login?market='+marketA[0]+':'+marketA[1]" class="link 11">{{ $t("login") }}</a> {{ $t("or") }} <a :href="'#/register?market='+marketA[0]+':'+marketA[1]" class="link">{{ $t("create account") }}</a> {{ $t("to trade") }}</div>
                                ...
                                <div class="all" >
                                    <div class="detailList " style="position: relative"  :class="[{tradesStyle_bg:trades_tabs == '2'},{detailList_n:trades_tabs == '1'}]">
                                        <ul class="detail yangDetail" style="width: 100%;position: absolute;bottom: 0">
                                            <li  v-show="show_second" style="color: #cccccc; font-size: 14px; text-align: center">{{$t("no records")}}</li>
                                            <li class=""  v-for="item in tradesData_s" @click="priceChange(item[0])">
                                                <p class="red"  style=" font-family: Helvetica;">{{math_make(item[0],'p')}}</p>
                                                <p class="" style=" font-family: Helvetica;">{{math_make(item[1],'n')}}</p>
                                                <p class="" style=" font-family: Helvetica;">{{math_multiply(item[0],item[1])}}</p>
                                    ...
                                    <div class="numberOnly">
                                        <h2 class="number" style=" font-family: Helvetica;" >{{math_make(newDeal,'p')}}</h2>
                                    </div>
                                    <div class="detailList "  :class="[{tradesStyle_bg:trades_tabs == '1'},{detailList_n:trades_tabs == '2'}]">
                                        <ul class="detail yinDetail">
                                            <li v-show="show_none" style="color: #cccccc; font-size: 14px; text-align: center">{{$t("no records")}}</li>
                                            <li class="" v-for="item in tradesData_b" @click="priceChange(item[0])">
                                                <p class="green" style=" font-family: Helvetica;">{{math_make(item[0],'p')}}</p>
                                                <p class="" style=" font-family: Helvetica;">{{math_make(item[1],'n')}}</p>
                                                <p class="" style=" font-family: Helvetica;">{{math_multiply(item[0],item[1])}}</p>
                    ...
                    <div class="marketDeal">
                        <div class="myData_m ">
                            <div class=" myDataList ">
                                ...
                                <dealList ref="dealList" :implement="dealStatus" :marketCoin="marketCoin" :market="marketA[0]" :coin="marketA[1]" @capitalnew="capitalnew"  :NdealStatue="NdealStatue"></dealList>
                            </div>
                        </div>
                    </div>
                    <!-- 数据主体区 end -->
            ...
            <div class="openM" v-show="isopen">
                ...
                <div class="but">
                    <el-button style="padding: 9px 15px;"  @click="close() ">{{$t('Cancel')}}</el-button>
                    <el-button  style="padding: 9px 15px;"  @click="dealTrue()" type="primary">{{$t('Confirm')}}</el-button>
                </div>
            </div>
    ...
    font-weight: 700;    border-bottom: 1px solid #e6e6e6;">{{$t("My 24h Order History")}}</h2>
               <el-button  :disabled="mesage==''?true:false"  @click="goNextTO('marketthird','orderMarketList','orderStatus')" style="height: 25px;line-height: 25px; padding: 0px 13px;float: right;margin-top: -31px">
                   {{$t("See All")}}
                </el-button>
           </div>
           <div class="main">
               <table  class="table" >
                ...
                <tbody>
                     <div :class="{none: mesage != ''}"
                            ...
                            margin-left: 11px;
                            text-align: center;">
                        <p class=" " style="font-weight: 500; color: #333333;">{{$t("no records")}}</p>
                    </div>
                    <tr v-for="item in mesage">
                        <td>{{(formatDate(item.update_time).slice(5))}}</td>
                         <!-- <td style="font-family: Helvetica;" class="space1" :title="dateTime(item.update_time)">{{(item.update_time+'').length<=13 ? new Date(item.update_time* 1000).toLocaleString().replace(/\//g, "-").substr(5):item.update_time.substr(5)}}</td> -->
                          ...
                          <td  :class="item.type == 1 ?'green' : 'red'" style="text-align:left;">{{item.type == 1 ? $t('buy') : $t('sell')}}</td>
